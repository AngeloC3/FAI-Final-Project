...
topic = input("Please enter the wiki topic for which you want to generate keywords: ")
mode = bool(input("Enter 0 if you want to use see the keyword itself and 1 if you want to match it with a list of keywords: "))
list_of_topics=[]
if mode:
    while True:
        
        val = input("Press *q to quit. Enter any other keyword to include it in the list: ")
        if val=="*q":
            break
        else:
